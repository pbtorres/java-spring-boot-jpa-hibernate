...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2022-08-20T12:41:11Z"), u1);
		Order o2 = new Order(null, Instant.parse("2022-08-20T12:41:11Z"), u2);
		Order o3 = new Order(null, Instant.parse("2022-08-20T10:43:22Z"), u2);
